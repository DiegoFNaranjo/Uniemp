...
import 'menu_quotes.dart';

class crearCotizacion extends StatefulWidget {
  const crearCotizacion({super.key});
    ...
    if (_rucClienteController.text.isEmpty ||
      ...
      try {
        ...
        await _firestore
            ...
            .set({
          'Numero': numeroCotizacion.toString(),
          'Fecha': dateStr,
          'Cliente': cliente,
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Cotización creada satisfactoriamente',
                style: TextStyle(
                    color: Colors.white,
                    fontSize: 15,
