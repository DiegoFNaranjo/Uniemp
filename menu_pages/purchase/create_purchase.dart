...
import 'menu_purchase.dart';

class crearCompra extends StatefulWidget {
  const crearCompra({super.key});

  @override
  _crearCompraState createState() => _crearCompraState();
}
...
class _crearCompraState extends State<crearCompra> {
    ...
    try {
      ...
      if (documentSnapshot.exists) {
        ...
        setState(() {
          ...
          _precio1Controller.text = dataP1['precio compra'];
    ...
    try {
      ...
      if (documentSnapshot.exists) {
        ...
        setState(() {
          ...
          _precio2Controller.text = dataP2['precio compra'];
    ...
    try {
      ...
      if (documentSnapshot.exists) {
        ...
        setState(() {
          ...
          _precio3Controller.text = dataP3['precio compra'];
    ...
    try {
      ...
      if (documentSnapshot.exists) {
        ...
        setState(() {
          ...
          _precio4Controller.text = dataP4['precio compra'];
    ...
    try {
      ...
      if (documentSnapshot.exists) {
        ...
        setState(() {
          ...
          _precio5Controller.text = dataP5['precio compra'];
    ...
    try {
      ...
      if (documentSnapshot.exists) {
        ...
        setState(() {
          ...
          _precio6Controller.text = dataP6['precio compra'];
  ...
  void _crearOrdenCompra() async {
    ...
    if (_rucProveedorController.text.isEmpty ||
      ...
      try {
        String collectionNameOrdenCompra = '${ruc!}ORDEN DE COMPRA';
        QuerySnapshot querySnapshot = await FirebaseFirestore.instance
            .collection(collectionNameOrdenCompra)
        ...
        if (querySnapshot.docs.isNotEmpty) {
          numeroOrdenCompra =
              int.parse(querySnapshot.docs[0]['Numero'].toString());
          numeroOrdenCompra = numeroOrdenCompra! + 1;
        } else {
          numeroOrdenCompra = 500;
        }
        ...
        await _firestore
            ...
            .set({
          'Numero': numeroOrdenCompra.toString(),
          'Fecha': dateStr,
          'Proveedor': proveedor,
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Orden de Compra creada satisfactoriamente',
                style: TextStyle(
                    color: Colors.white,
                    fontSize: 15,
                ...
                const Row(
                    ...
                    children: [
                      SizedBox(
                        ...
                        height: 15,
                        child:
                            Text('RUC Proveedor', style: TextStyle(fontSize: 10)),
                      ),
                      SizedBox(
                        width: 180,
                        height: 15,
                        child: Text('Proveedor', style: TextStyle(fontSize: 10)),
                      )
                    ]),
                Row(
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
